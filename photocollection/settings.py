"""
Django settings for photocollection project.
...
ROOT_URLCONF = 'photocollection.urls'
...
WSGI_APPLICATION = 'photocollection.wsgi.application'
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'photocollection/static'),
]
STATICFILES_FINDERS = (
